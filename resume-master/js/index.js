$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫刘少博,是一名应届大学生</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我希望的工作是web前端开发</div>",2000);
	...
	w.load("<p><div class='writecode'>刘少博</div>");

	w.load("<div class='writecode'>web前端工程师</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:979828958@qq.com</li>");
	w.load("<li class='writecode'>blog:<a href='http://www.frenkiss.site' target='_blank'>frenkiss.site</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/frienkiss' target='_blank'>https://github.com/frienkiss</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>专业技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>有着四年的编程学习经验：C/C++,java等编程语言基础</li>");
	w.load("<li class='writecode'>熟悉数据结构算法、sql数据库基本操作</li>");
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,javascript</li>");
	// w.load("<li class='writecode'>熟练与各平台和硬件的技术对接（如: 微信接口，三方支付，系统整合）</li>");
	w.load("<li class='writecode'>了解Nodejs技术和jquery库的运用 </li>");
	w.load("<li class='writecode'>能解决不同浏览器，不同版本的兼容问题</li>");
	w.load("<li class='writecode'>熟悉Chrome,Firefox,IE浏览器的调试工作</li>");
	w.load("<li class='writecode'> 熟悉Es5标准，目前正在学习使用Es6标准，专攻js</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>开发经验</h1>");
	w.load("<ul>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode writecode1'>&nbsp;*这样基本上就差不多了</div>");
	c.load("<div class='comment writecode'>&nbsp;*");
	c.load("<div class='comment writecode writecode1'>&nbsp;*如果你想和我联系</div>");
	c.load("<div class='comment writecode writecode1'>&nbsp;*QQ/微信:979828958</div>");
	c.load("<div class='comment writecode writecode1'>&nbsp;*mobile:15895951936</div>");
	c.load("<div class='comment writecode writecode1'>&nbsp;*最后非常感谢您愿意花3分钟看完我的简历！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
